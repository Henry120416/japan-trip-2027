...
async function reset() {
  ...
  const P1_EXP = [
    ...
    // ── D2：4/18 宇治・東寺 ───────────────────────────────────
    ['2027-04-18','JR宇治線往返×6',               3480,   725, '', '580円/人往返（290円×2）'],
    ...
    ['2027-04-19','石板路午餐・京都定食×6',        10800,  2250, '', '預估1,800円/人；三年坂周邊定食'],
    ['2027-04-19','京都和牛燒肉晚餐×6',            36000,  7500, '', '預估6,000円/人；木屋町通周邊燒肉'],

    // ── D4：4/20 嵐山・金閣寺・移大阪 ───────────────────────
    ['2027-04-20','嵐山竹林午餐×6',               10800,  2250, '', '預估1,800円/人；嵐山渡月橋周邊'],
    ...
    ['2027-04-20','道頓堀晚餐・串炸/章魚燒×6',    12000,  2500, '', '預估2,000円/人；道頓堀夜遊'],

    // ── D5：4/21 神戶一日遊 ───────────────────────────────────
    ['2027-04-21','阪神電車往返（大阪↔神戶三宮）×6',3960,   825, '', '330円×2/人；梅田出發'],
    ['2027-04-21','北野異人館入場費×6',             4800,  1000, '', '預估800円/人（風見鶏の館等）'],
    ['2027-04-21','頂級神戶牛鐵板燒午餐×6',        36000,  7500, '', '預估6,000円/人；神戶三宮周邊'],
    ['2027-04-21','神戶港灣・美利堅公園茶點×6',     6000,  1250, '', '預估1,000円/人；咖啡飲料點心'],
    ['2027-04-21','摩耶山ロープウェイ往返×6',      10200,  2125, '', '1,700円/人往返'],

    // ── D6：4/22 黑門・Outlet・返程 ──────────────────────────
    ['2027-04-22','黑門市場早餐・海鮮×6',          12000,  2500, '', '預估2,000円/人；生魚片/海鮮燒烤'],
    ['2027-04-22','臨空城午餐・輕食×6',             9000,  1875, '', '預估1,500円/人'],
    ['2027-04-22','南海電車（難波→KIX）×6',         6120,  1275, '', '1,020円/人'],

    // ── 共用・京都市區交通 ────────────────────────────────────
    ['2027-04-17','京都市區公車・地鐵（3日）×6',   12600,  2625, '', '預估700円/人/日 × 3天（含公車1日券等）'],
  ];

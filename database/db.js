...
if (USE_PG) {
  ...
  initDB = async () => {
    ...
    const expSeed = await pool.query(`SELECT 1 FROM trip_info WHERE category='system' AND key='expenses_v8'`);
    if (!expSeed.rows.length) {
      await pool.query(`DELETE FROM expenses`);
      await pool.query(`DELETE FROM trip_info WHERE category='system' AND key IN ('expenses_v1','expenses_v2','expenses_v3','expenses_v4','expenses_v5','expenses_v6','expenses_v7')`);
      const dayId = async d => {
      ...
      await addExp('2027-04-17', '晚餐 燒肉弘（6人）',              30000,  6250, '極熱門，¥5,000/人，需提前30天預約');
      await addExp('2027-04-17', '飲料・零食・便利商店',              6000,  1250, '¥1,000/人');
      // ── D2 2027-04-18
      await addExp('2027-04-18', '早餐 喫茶店・便利商店（6人）',      4200,   875, '¥700/人');
      ...
      await addExp('2027-04-18', '午餐 江戶川鰻魚飯（6人）',        18000,  3750, '近鐵奈良站，¥3,000/人');
      await addExp('2027-04-18', '錦市場小吃（6人）',               10800,  2250, '¥1,800/人，邊走邊吃');
      await addExp('2027-04-18', '晚餐 京都勝牛（6人）',            21000,  4375, '河原町店，¥3,500/人，現場排隊');
      await addExp('2027-04-18', '飲料・零食・便利商店',              6000,  1250, '¥1,000/人');
      // ── D3 2027-04-19
      await addExp('2027-04-19', '早餐 便利商店（6人）',              4200,   875, '¥700/人');
      ...
      await addExp('2027-04-19', '午餐 貴船川床料理（6人）',         36000,  7500, '川床季節料理，¥6,000/人');
      ...
      await addExp('2027-04-20', '早餐 阿古屋茶屋（6人）',           12000,  2500, '09:45前先現場登記，¥2,000/人');
      await addExp('2027-04-20', '午餐 産寧坂・八坂周邊（6人）',     15000,  3125, '茶屋・蕎麥麵，¥2,500/人');
      await addExp('2027-04-20', '計程車 飯店→京都站（2台）',         2400,   500, '退房攜大件行李');
      await addExp('2027-04-20', 'JR新快速 京都→大阪（6人×¥570）',  3420,   713, '不需預約，每10分一班');
      await addExp('2027-04-20', '晚餐 北極星大阪燒（6人）',          18000,  3750, '心齋橋本店，¥3,000/人，無需預約');
      await addExp('2027-04-20', '飲料・零食・便利商店',               6000,  1250, '¥1,000/人');
      // ── D5 2027-04-21
      await addExp('2027-04-21', '黑門市場海鮮（6人）',               15000,  3125, '¥2,500/人，黑門三平+石橋關東煮+黑銀');
      ...
      await pool.query(`INSERT INTO trip_info (category,key,value,sort_order) VALUES ('system','expenses_v8','1',9999) ON CONFLICT DO NOTHING`);
    }

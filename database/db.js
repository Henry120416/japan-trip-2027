  ...
  initDB = async () => {
    ...
    if (parseInt(p1ec.rows[0].c) < 20) {
      ...
      const P1_EXP = [
        ...
        ['2027-04-17','先斗町壽喜燒/京料理晚餐×6',   30000,  6250, '', '預估5,000円/人，含飲料'],
        ['2027-04-17','京都市區公車・地鐵（3日）×6', 12600,  2625, '', '預估700円/人/日 × 3天'],
        // D2：4/18
        ['2027-04-18','JR宇治線往返×6',               3480,   725, '', '290円/人單程；往返580円'],
        ['2027-04-18','平等院鳳凰堂入場費×6',          3600,   750, '', '600円/人'],
        ['2027-04-18','中村藤吉抹茶午餐×6',           15000,  3125, '', '預估2,500円/人，含抹茶甜點套餐'],
        ['2027-04-18','東寺入場費×6',                  3000,   625, '', '500円/人'],
        ['2027-04-18','伊勢丹美食街晚餐×6',           12000,  2500, '', '預估2,000円/人，京都車站B1~B2'],
        // D3：4/19
        ['2027-04-19','清水寺入場費×6',                3000,   625, '', '500円/人'],
        ['2027-04-19','石板路午餐・京都定食×6',        10800,  2250, '', '預估1,800円/人，三年坂周邊'],
        ['2027-04-19','京都和牛燒肉晚餐×6',            36000,  7500, '', '預估6,000円/人，木屋町通周邊'],
        // D4：4/20
        ['2027-04-20','嵐山竹林午餐×6',               10800,  2250, '', '預估1,800円/人，渡月橋周邊'],
        ...
        ['2027-04-20','道頓堀晚餐・串炸/章魚燒×6',    12000,  2500, '', '預估2,000円/人'],
        // D5：4/21
        ['2027-04-21','阪神電車往返（大阪↔神戶三宮）×6',3960,  825, '', '330円×2/人，梅田出發'],
        ['2027-04-21','北野異人館入場費×6',             4800,  1000, '', '預估800円/人（風見鶏の館等）'],
        ['2027-04-21','頂級神戶牛鐵板燒午餐×6',        36000,  7500, '', '預估6,000円/人'],
        ['2027-04-21','神戶港灣・美利堅公園茶點×6',     6000,  1250, '', '預估1,000円/人，咖啡飲料'],
        ['2027-04-21','摩耶山ロープウェイ往返×6',      10200,  2125, '', '1,700円/人往返'],
        // D6：4/22
        ['2027-04-22','黑門市場早餐・海鮮×6',          12000,  2500, '', '預估2,000円/人'],
        ['2027-04-22','臨空城午餐・輕食×6',             9000,  1875, '', '預估1,500円/人'],

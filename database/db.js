...
const PLAN2_ACTS = [
  // ── D1 2027-04-17 啟程・前往京都 ──
  ['2027-04-17',1,'12:15','transport','搭HARUKA特急・關西空港→京都','關西國際空港（KIX）',34.4347,135.2440,
   '搭乘HARUKA特急，關西空港→京都站約75分鐘（¥2,200/人）。外國人優惠票需提前購買。'],
  ['2027-04-17',2,'14:00','transport','抵達京都駅','京都駅（JR 中央口）',34.9858,135.7585,
   '▶ 搭計程車（2台）直達飯店，攜帶大件行李最省力，約¥1,200/台。'],
  ['2027-04-17',3,'14:30','hotel','Check-in・MIMARU 京都五條','MIMARU KYOTO GOJO',34.9983,135.7571,
   '6人公寓式套房，地鐵烏丸線五条駅步行3分。放行李、稍作休息，準備探索京都。'],
  ['2027-04-17',4,'18:30','attraction','鴨川夕陽散策','鴨川（三条〜四条段）',35.0042,135.7704,
   '從飯店步行前往鴨川三条段。台階上坐滿本地人野餐談天，感受京都第一個黃昏。'],
  ['2027-04-17',5,'20:00','food','晚餐・燒肉弘','燒肉弘（京都木屋町）',35.0046,135.7684,
   '極人氣燒肉店，需提前30天預約。¥5,000/人起，性價比極高。'],
  // ── D2 2027-04-18 奈良日帰り ──
  ['2027-04-18',1,'07:45','transport','搭近鐵往奈良（丹波橋換乘）','出町柳→丹波橋→近鐵奈良',35.0398,135.7736,
   '搭公車→出町柳，轉京阪→丹波橋（¥280），換乘近鐵急行→近鉄奈良（¥780）。全程約55分。'],
  ['2027-04-18',2,'09:10','attraction','東大寺・奈良大佛','東大寺（大佛殿）',34.6888,135.8398,
   '世界最大木造建築，供奉日本最大銅佛（高15公尺），UNESCO世界遺產。門票¥800，早晨人潮最少。'],
  ['2027-04-18',3,'10:30','attraction','奈良公園・餵小鹿','奈良公園',34.6854,135.8396,
   '1,200頭自由漫步的神鹿，被視為神的使者。買一包鹿煎餅（¥150）即可近距離互動。'],
  ['2027-04-18',4,'12:30','food','午餐・江戶川鰻魚飯','江戶川（近鉄奈良站周邊）',34.6853,135.8295,
   '近鐵奈良站周邊名店，¥3,000/人。鰻魚飯是奈良定番，無需預約。'],
  ['2027-04-18',5,'14:00','transport','返回京都','近鉄奈良駅',34.6845,135.8326,
   '搭近鐵→丹波橋→京阪→出町柳，返回京都市區。約55分鐘。'],
  ['2027-04-18',6,'16:00','attraction','錦市場散策','錦市場',35.0038,135.7674,
   '「京都廚房」，全長390公尺、130家店鋪。醃漬物、豆腐、玉子燒、烤海鮮，邊走邊吃。'],
  ['2027-04-18',7,'19:00','food','晚餐・京都勝牛','京都勝牛（河原町店）',35.0057,135.7699,
   '河原町人氣炸牛排，¥3,500/人，現場排隊，無需預約。'],
  // ── D3 2027-04-19 貴船慢活 ──
  ['2027-04-19',1,'07:40','transport','搭叡山電鐵往貴船','出町柳駅（叡山電鐵）',35.0398,135.7736,
   '搭京阪→出町柳，轉叡山電鐵→貴船口（¥430），再搭公車33號→貴船（¥170）。07:40出發，09:10抵達。'],
  ['2027-04-19',2,'09:10','transport','抵達貴船口・換公車','貴船口駅',35.1059,135.7637,
   '搭京都巴士33號→貴船（5分，¥170），沿紅燈籠參道步行上山前往貴船神社。'],
  ['2027-04-19',3,'09:30','attraction','貴船神社・本宮','貴船神社',35.1232,135.7601,
   '水の神社，全日本2,000多間貴船神社的總本社。紅燈籠參道為標誌性畫面。'],
  ['2027-04-19',4,'10:40','attraction','水占卜（水占おみくじ）','貴船神社奧宮',35.1254,135.7582,
   '將御神籤放入清澈的貴船川，神諭文字緩緩浮現。¥300/張，貴船最獨特體驗。'],
  ['2027-04-19',5,'12:00','food','午餐・貴船川床料理','貴船川床（料理旅館）',35.1185,135.7607,
   '川床懷石料理，¥6,000/人。需提前預約。'],
  ['2027-04-19',6,'15:00','transport','返回京都市區','貴船口駅',35.1059,135.7637,
   '搭巴士→貴船口（¥170），叡山電鐵→出町柳（¥430），京阪→祇園四条（¥210）。'],
  ['2027-04-19',7,'19:00','food','晚餐・祇園牛禪壽喜燒','祇園 牛禪（花見小路周邊）',35.0042,135.7762,
   '祇園高級壽喜燒，¥9,000/人，建議7天前預約。'],
  // ── D4 2027-04-20 清水寺・伏見稻荷→轉大阪 ──
  ['2027-04-20',1,'05:50','transport','計程車→伏見稻荷','MIMARU 京都五條',34.9983,135.7571,
   '清晨5:50搭計程車（2台）直奔伏見稻荷，約20分鐘，¥1,200/台。'],
  ['2027-04-20',2,'06:05','attraction','伏見稻荷大社（清晨）','伏見稻荷大社',34.9672,135.7727,
   '千本鳥居清晨最魔幻時刻，幾乎無人。24小時免費開放，快步走完前段約50分鐘。'],
  ['2027-04-20',3,'07:05','transport','計程車→清水寺','伏見稻荷大社前',34.9672,135.7727,
   '在伏見稻荷門口叫計程車→清水寺（約15分，¥1,500）。'],
  ['2027-04-20',4,'07:45','attraction','清水寺（清晨無人）','清水寺',34.9948,135.7851,
   '平日早晨幾乎空場！UNESCO世界遺產，「清水之舞台」俯瞰京都市區。門票¥500，06:00開門。'],
  ['2027-04-20',5,'08:30','food','早餐・阿古屋茶屋','阿古屋茶屋（清水坂）',34.9981,135.7845,
   '09:45前先現場登記候位，¥2,000/人，清水坂名物早餐。'],
  ['2027-04-20',6,'09:15','attraction','二年坂・三年坂','二年坂・産寧坂',34.9968,135.7847,
   '京都最上鏡石板老街，兩旁清水燒・抹茶甜點店，往下坡走邊走邊吃。'],
  ['2027-04-20',7,'10:30','food','午餐・産寧坂周邊','産寧坂・八坂周邊',34.9990,135.7848,
   '茶屋・蕎麥麵，¥2,500/人。'],
  ['2027-04-20',8,'11:30','attraction','八坂神社・祇園散策','八坂神社',35.0037,135.7786,
   '祇園祭主場神社，往南走花見小路。境內免費，24小時開放。'],
  ['2027-04-20',9,'13:30','transport','京都→大阪（JR新快速）','京都駅',34.9858,135.7585,
   '搭JR京都線新快速→大阪駅（28分，¥570），不需預約，每10分一班。'],
  ['2027-04-20',10,'15:00','hotel','Check-in・MIMARU 大阪難波','MIMARU OSAKA NAMBA',34.6625,135.5010,
   '6人公寓式套房。地下鐵御堂筋線難波駅步行5分。'],
  ['2027-04-20',11,'19:00','food','晚餐・北極星大阪燒','北極星（心齋橋本店）',34.6735,135.5003,
   '大阪燒發祥地，¥3,000/人，無需預約。心齋橋本店。'],
  // ── D5 2027-04-21 大阪市區探索 ──
  ['2027-04-21',1,'09:00','food','黑門市場海鮮','黑門市場（日本橋）',34.6653,135.5073,
   '「大阪廚房」，現場直食海膽・螃蟹・生蠔。早上越早越新鮮，¥2,500/人。'],
  ['2027-04-21',2,'11:00','attraction','心齋橋・道頓堀','心齋橋筋・道頓堀',34.6699,135.5008,
   '格利科跑者打卡，逛藥妝・松本清・大丸心齋橋，全長600公尺商店街。'],
  ['2027-04-21',3,'14:00','transport','地鐵→梅田','難波→梅田（御堂筋線）',34.7024,135.4959,
   '搭大阪Metro御堂筋線難波→梅田，3站約5分，¥180。'],
  ['2027-04-21',4,'14:30','attraction','梅田・Grand Front大阪','梅田・Grand Front大阪',34.7055,135.4983,
   'Grand Front B1~6F集合美食・購物・展覽。阪急百貨、HEP FIVE摩天輪亦在此區。'],
  ['2027-04-21',5,'16:30','attraction','梅田空中庭園展望台','梅田スカイビル（空中庭園）',34.7057,135.4899,
   '高173公尺，俯瞰百萬夜景。票價¥2,000，傍晚至夜景最佳時段。'],
  ['2027-04-21',6,'19:00','food','晚餐・和牛燒肉M法善寺','和牛焼肉M 法善寺横丁',34.6686,135.5024,
   '¥12,000/人，頂級和牛，法善寺横丁隱巷名店。需2週前官網預約。'],
  // ── D6 2027-04-22 臨空城・返程 ──
  ['2027-04-22',1,'08:30','hotel','Check-out・退房','MIMARU 大阪難波',34.6625,135.5010,
   '完成退房，大件行李存投幣置物箱或帶至南海難波駅。'],
  ['2027-04-22',2,'09:00','transport','南海電車→臨空城','南海難波駅',34.6659,135.5019,
   '搭南海電車空港急行→りんくうタウン駅（38分，¥920），Outlet出站步行3分。'],
  ['2027-04-22',3,'09:45','attraction','臨空城 Premium Outlets','臨空城 RINKU PREMIUM OUTLETS',34.4317,135.3069,
   '超過210家國際精品品牌，可邊購物邊眺望大阪灣和飛機起降。記得辦理退稅（¥5,000以上）。'],
  ['2027-04-22',4,'12:00','food','午餐・金子半之助天丼','金子半之助（臨空城）',34.4317,135.3069,
   'Outlet美食街，¥1,500/人，無需預約。酥脆天丼。'],
  ['2027-04-22',5,'13:10','transport','前往關西機場','りんくうタウン駅',34.4317,135.3069,
   '步行回駅，搭南海電車→關西空港駅（5分，¥100）。'],
  ['2027-04-22',6,'13:30','transport','抵達KIX・辦理登機','關西國際空港（KIX）',34.4347,135.2440,
...
if (USE_PG) {
  ...
  initDB = async () => {
    ...
    if (parseInt(dc.rows[0].c) === 0) {
      ...
      if (!p1title.includes('京都慢慢開始') || !p1notes.includes('[t6]')) {
        for (const d of P1_DAYS) {
    ...
    const expSeed = await pool.query(`SELECT 1 FROM trip_info WHERE category='system' AND key='expenses_v9'`);
    if (!expSeed.rows.length) {
      await pool.query(`DELETE FROM expenses`);
      await pool.query(`DELETE FROM trip_info WHERE category='system' AND key IN ('expenses_v1','expenses_v2','expenses_v3','expenses_v4','expenses_v5','expenses_v6','expenses_v7','expenses_v8')`);
      const dayId = async d => {
      ...
      // ── D1 2027-04-17
      await addExp('2027-04-17', '住宿 MIMARU 京都五條（3晚）', 198798, 39444, '¥198,798 ÷ 5.04 = NT$39,444');
      await addExp('2027-04-17', 'HARUKA特急（6人×¥2,200）',    13200,  2619, '外國人優惠票，含指定席');
      await addExp('2027-04-17', 'ICOCA儲值（6人×¥3,000）',     18000,  3571, '含押金¥500，可退款');
      await addExp('2027-04-17', '計程車 京都站→飯店（2台）',    2400,    476, '攜帶大件行李建議計程車');
      await addExp('2027-04-17', '晚餐 燒肉弘（6人）',           30000,  5952, '極熱門，¥5,000/人，需提前30天預約');
      await addExp('2027-04-17', '飲料・零食・便利商店',           6000,  1190, '¥1,000/人');
      // ── D2 2027-04-18
      await addExp('2027-04-18', '早餐 喫茶店・便利商店（6人）',   4200,   833, '¥700/人');
      await addExp('2027-04-18', '電車 往返奈良（6人×¥1,060×2）',12720,  2524, '京阪+近鐵丹波橋換乘');
      await addExp('2027-04-18', '入場費 東大寺（6人×¥800）',     4800,   952, '世界最大木造建築');
      await addExp('2027-04-18', '午餐 江戶川鰻魚飯（6人）',      18000,  3571, '近鐵奈良站，¥3,000/人');
      await addExp('2027-04-18', '錦市場小吃（6人）',             10800,  2143, '¥1,800/人，邊走邊吃');
      await addExp('2027-04-18', '晚餐 京都勝牛（6人）',          21000,  4167, '河原町店，¥3,500/人，現場排隊');
      await addExp('2027-04-18', '飲料・零食・便利商店',           6000,  1190, '¥1,000/人');
      // ── D3 2027-04-19
      await addExp('2027-04-19', '早餐 便利商店（6人）',           4200,   833, '¥700/人');
      await addExp('2027-04-19', '電車 叡山電鐵往返貴船口（6人）', 5160,  1024, '出町柳↔貴船口');
      await addExp('2027-04-19', '接駁公車 往返貴船神社（6人）',   2040,   405, '¥170×2×6');
      await addExp('2027-04-19', '門票 貴船神社水占卜（6人×¥300）',1800,   357, '特殊體驗，放入水中顯字');
      await addExp('2027-04-19', '午餐 貴船川床料理（6人）',       36000,  7143, '川床季節料理，¥6,000/人');
      await addExp('2027-04-19', '晚餐 祇園牛禪壽喜燒（6人）',     54000, 10714, '祇園高級店，¥9,000/人，建議7天前預約');
      await addExp('2027-04-19', '飲料・零食・便利商店',            6000,  1190, '¥1,000/人');
      // ── D4 2027-04-20
      await addExp('2027-04-20', '住宿 MIMARU 大阪難波（2晚）', 185398, 36785, '¥185,398 ÷ 5.04 = NT$36,785');
      await addExp('2027-04-20', '計程車 飯店→伏見稻荷（2台）',   3600,   714, '清晨5:50出發');
      await addExp('2027-04-20', '計程車 伏見稻荷→清水寺（2台）', 3000,   595, '清晨光線最美時段移動');
      await addExp('2027-04-20', '入場費 清水寺（6人×¥500）',     3000,   595, '6:00開門，晨光最佳');
      await addExp('2027-04-20', '早餐 阿古屋茶屋（6人）',        12000,  2381, '09:45前先現場登記，¥2,000/人');
      await addExp('2027-04-20', '午餐 産寧坂・八坂周邊（6人）',  15000,  2976, '茶屋・蕎麥麵，¥2,500/人');
      await addExp('2027-04-20', '計程車 飯店→京都站（2台）',      2400,   476, '退房攜大件行李');
      await addExp('2027-04-20', 'JR新快速 京都→大阪（6人×¥570）',3420,   679, '不需預約，每10分一班');
      await addExp('2027-04-20', '晚餐 北極星大阪燒（6人）',       18000,  3571, '心齋橋本店，¥3,000/人，無需預約');
      await addExp('2027-04-20', '飲料・零食・便利商店',            6000,  1190, '¥1,000/人');
      // ── D5 2027-04-21
      await addExp('2027-04-21', '黑門市場海鮮（6人）',            15000,  2976, '¥2,500/人，黑門三平+石橋關東煮+黑銀');
      await addExp('2027-04-21', '地鐵 難波↔梅田往返（6人）',       2160,   429, '御堂筋線¥180×2×6');
      await addExp('2027-04-21', '晚餐 和牛燒肉M法善寺（6人）',     72000, 14286, '¥12,000/人，極穩極推，2週前官網預約');
      await addExp('2027-04-21', '門票 梅田空中庭園（6人×¥2,000）',12000,  2381, '高173m俯瞰百萬夜景');
      await addExp('2027-04-21', '飲料・零食・便利商店',             6000,  1190, '¥1,000/人');
      // ── D6 2027-04-22
      await addExp('2027-04-22', '電車 南海 難波→臨空城+KIX（6人）',6240,  1238, '¥920→臨空城，¥120→KIX');
      await addExp('2027-04-22', '午餐 金子半之助天丼（6人）',       9000,  1786, 'Outlet美食街，¥1,500/人，無需預約');
      await addExp('2027-04-22', '飲料・零食・便利商店',              3000,   595, '¥500/人，半天');

      await pool.query(`INSERT INTO trip_info (category,key,value,sort_order) VALUES ('system','expenses_v9','1',9999) ON CONFLICT DO NOTHING`);
    }
